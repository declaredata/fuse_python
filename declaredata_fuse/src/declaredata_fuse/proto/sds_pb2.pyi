...
class Column(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["col_coalesce", b"col_coalesce", "col_derived", b"col_derived", "col_lit", b"col_lit", "col_name", b"col_name", "col_spec", b"col_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["col_coalesce", b"col_coalesce", "col_derived", b"col_derived", "col_lit", b"col_lit", "col_name", b"col_name", "col_spec", b"col_spec"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["col_spec", b"col_spec"]) -> typing.Literal["col_name", "col_derived", "col_lit", "col_coalesce"] | None: ...
