...
class Agg(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_alias", b"_alias", "alias", b"alias", "col_name", b"col_name", "op", b"op"]) -> None: ...
...
class WithColumnRequest(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["dataframe_uid", b"dataframe_uid", "new_col", b"new_col"]) -> None: ...
...
class Column(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_window", b"_window", "col_coalesce", b"col_coalesce", "col_derived", b"col_derived", "col_lit", b"col_lit", "col_name", b"col_name", "col_spec", b"col_spec", "window", b"window"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_window", b"_window", "col_coalesce", b"col_coalesce", "col_derived", b"col_derived", "col_lit", b"col_lit", "col_name", b"col_name", "col_spec", b"col_spec", "window", b"window"]) -> None: ...
    @typing.overload
