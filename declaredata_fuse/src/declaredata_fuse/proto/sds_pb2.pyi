...
class _AggOperationEnumTypeWrapper(google.protobuf.internal.enum_type_wrapper._EnumTypeWrapper[_AggOperation.ValueType], builtins.type):
    DESCRIPTOR: google.protobuf.descriptor.EnumDescriptor
...
class AggregateRequest(google.protobuf.message.Message):
    ...
    @property
    def aggs(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___Agg]: ...
    def __init__(
        self,
        *,
        dataframe_uid: builtins.str = ...,
    ...
    def ClearField(self, field_name: typing.Literal["aggs", b"aggs", "dataframe_uid", b"dataframe_uid", "group_by", b"group_by"]) -> None: ...
...
class Agg(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_alias", b"_alias", "_window", b"_window", "alias", b"alias", "window", b"window"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_alias", b"_alias", "_window", b"_window", "alias", b"alias", "col_name", b"col_name", "op", b"op", "window", b"window"]) -> None: ...
    @typing.overload
...
class WithColumnRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aggregation", b"aggregation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aggregation", b"aggregation", "dataframe_uid", b"dataframe_uid", "new_col_name", b"new_col_name"]) -> None: ...
...
class WindowSpec(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["left_boundary", b"left_boundary", "order_by", b"order_by", "partition_by", b"partition_by", "right_boundary", b"right_boundary"]) -> None: ...
...
class Column(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["col_derived", b"col_derived", "col_lit", b"col_lit", "col_name", b"col_name", "col_spec", b"col_spec"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["col_derived", b"col_derived", "col_lit", b"col_lit", "col_name", b"col_name", "col_spec", b"col_spec"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["col_spec", b"col_spec"]) -> typing.Literal["col_name", "col_derived", "col_lit"] | None: ...
...
class LiteralColumn(google.protobuf.message.Message):
    ...
    name: builtins.str
    @property
    def val(self) -> google.protobuf.internal.containers.RepeatedCompositeFieldContainer[global___TypedAny]: ...
    def __init__(
        self,
        *,
        name: builtins.str = ...,
